...
<div class="panel-display b2b-directory clearfix container <?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  <div class="row-fluid">
    <div class="b2b-full-container b2b-full-content b2b-full-content-region panel-panel span12">
    	
    	<div class="row row-company-info">
    		<div class="large-3 columns company-info-col1">
              <?php print $content['topspotlight-left']; ?>
    		</div>
    		<div class="large-4 columns company-info-col2">
              <?php print $content['topspotlight-center']; ?>
    		</div>
    		<div class="large-4 large-offset-1 columns company-info-col3">
			...
			<div class="row ">
				<div class="info large-9 large-centered medium-centered medium-10 small-10 small-centered columns">
					...
					<div class="row" data-equalizer >
						<div class="address_1 large-5 large-push-1 medium-push-1 medium-5 small-12 columns" data-equalizer-watch >					
							
							<?php print $content['address_part_1']; ?>
							
						</div>
					
						<div class="address_2 large-5 large-pull-1 medium-pull-1 medium-5 small-12 columns" data-equalizer-watch >
